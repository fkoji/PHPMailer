...
class JPHPMailer extends PHPMailer
{
	...
	protected $in_enc = "UTF-8"; //内部エンコード

    /**
     * 内部エンコードのセット
     */
    protected function setInternalEncoding($internalEncoding) {
        $in_enc = $internalEncoding;
    }
	...
	*/
	 ...
	 */
	protected function encodeMimeHeader($string,$charset=null,$linefeed="\r\n"){
		if (!strlen($string)){
			return "";
		}
